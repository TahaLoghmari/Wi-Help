...
internal sealed class UnlikeReview : IEndpoint
{
    public void MapEndpoint(IEndpointRouteBuilder app)
    {
        app.MapDelete(ReviewsEndpoints.UnlikeReview, async (
                Guid reviewId,
                HttpContext httpContext,
                ICommandHandler<UnlikeReviewCommand> handler,
                CancellationToken cancellationToken) =>
            {
                ...
                var command = new UnlikeReviewCommand(reviewId, currentUserId);
