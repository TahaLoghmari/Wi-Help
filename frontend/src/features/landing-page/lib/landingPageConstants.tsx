...
export const getStats = (t: TFunction): Stat[] => [
  {
    title: t("landing.stats.professionals.title"),
    description: t("landing.stats.professionals.description"),
    icon: () => (
      <svg
  ...
  {
    title: t("landing.stats.patients.title"),
    description: t("landing.stats.patients.description"),
    icon: () => (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 -960 960 960"
  ...
  {
    title: t("landing.stats.support.title"),
    description: t("landing.stats.support.description"),
    icon: () => (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 640 640"
  ...
  {
    title: t("landing.stats.rating.title"),
...
export const getServices = (t: TFunction): Service[] => [
  {
    ...
    title: t("landing.services.nursing.title"),
    description: t("landing.services.nursing.description"),
    href: "#",
  },
  {
    icon: () => (
    ...
    title: t("landing.services.physiotherapy.title"),
    description: t("landing.services.physiotherapy.description"),
    href: "#",
  },
  {
    icon: () => (
    ...
    title: t("landing.services.personalCare.title"),
    description: t("landing.services.personalCare.description"),
    href: "#",
  },
];
...
export const getSteps = (t: TFunction): Step[] => [
  ...
  {
    title: t("landing.steps.match.title"),
    description: t("landing.steps.match.description"),
  },
  {
...
export const getReviews = (t: TFunction): Review[] => [
  {
    ...
    name: "Sarah M.",
    numberOfStars: 5,
    reviewText: t("landing.reviews.sarah.review"),
  },
  {
    profilePictureUrl:
    ...
    name: "Ahmed K.",
    numberOfStars: 4,
    reviewText: t("landing.reviews.ahmed.review"),
  },
  {
    profilePictureUrl:
    ...
    name: "Fatima B.",
    numberOfStars: 5,
    reviewText: t("landing.reviews.fatima.review"),
  },
  {
    profilePictureUrl:
    ...
    name: "Mohamed C.",
    numberOfStars: 4,
    reviewText: t("landing.reviews.mohamed.review"),
  },
];
